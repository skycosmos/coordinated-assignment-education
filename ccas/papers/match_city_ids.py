...
from ccas.paths import papers_output_dir
...
def parse_args() -> argparse.Namespace:
    ...
    po = papers_output_dir()
    parser.add_argument(
        "--systems-csv",
        type=Path,
        default=po / "paper_to_ccas_systems.csv",
        help="Path to paper_to_ccas_systems CSV (default: under ccas/papers/output/).",
    )
    parser.add_argument(
        "--cities-csv",
        type=Path,
        default=po / "cities.csv",
        help="Path to cities CSV (default: under ccas/papers/output/).",
    )
