...
def main():
    ...
    input_path = Path(args.input) if args.input else PAPERS_OUT / "paper_to_metadata.csv"
    ...
    out_path = Path(args.output) if args.output else REL_OUT / "paper_predicted_scores.csv"
