...
# The object of this file is to define different functions that will be used in order to process papers of the project CCAS. It contains the following functions:
